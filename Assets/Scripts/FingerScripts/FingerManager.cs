...
public class FingerManager : MonoBehaviour 
{
	...
	public void TapFinger() 
	{
		...
		int randomPosition = Random.Range(0, press.Length);   // Coge una posición aleatoria de caída de dedo
		int randomRotation = Random.Range(0, 360);            // Coge una rotación aleatoria de dedo
