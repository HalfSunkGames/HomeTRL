...
public class FingerEvent : MonoBehaviour {
	...
	[Header("Prefabs")]
	//public GameObject keyboard;  // Prefab del teclado
	...
	// Añade segundos cuando el jugador se posa en el CTRL en dos intervalos de menos a más (depende velocidad actual)
